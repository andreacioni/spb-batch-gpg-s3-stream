...
public class CommonUtils {
    ...
    static void decrypt(OutputStream clearOut, PGPPrivateKey pgpPrivateKey, PGPPublicKeyEncryptedData publicKeyEncryptedData) throws IOException, PGPException {
        ...
        Object obj = decCompObjFac.nextObject();
        ...
        if(obj instanceof PGPCompressedData) {
            ...
            compressedDataStream = pgpLiteralData.getDataStream();
        }
     ...
     */
    static void copyAsLiteralData(OutputStream outputStream, InputStream in, int bufferSize) throws IOException {
